...
export const VoiceSelector = ({
  ...
  // Base UI's Dialog invokes onOpenChange with (open, eventDetails); that's
  // only available here, at the real Dialog call site, not inside the
  // single-arg controllable-state hook above.
